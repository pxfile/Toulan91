...
public class EditTribeInfoActivity extends Activity {
    ...
    private void initTitle() {
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(mTribeName.getText().toString())){
                    Notification.showToastMsg(EditTribeInfoActivity.this, "请输入群名称！");
                }else {
    ...
    private void createTribe(final YWTribeType type) {
        ...
        mTribeService.createTribe(new IWxCallback() {
            ...
            public void onError(int code, String info) {
                Notification.showToastMsg(EditTribeInfoActivity.this, "创建讨论组失败");
            }
