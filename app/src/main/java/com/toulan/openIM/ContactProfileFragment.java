...
public  class ContactProfileFragment extends Fragment implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mUserId = OpenImUtils.getImKit().getIMCore().getLoginUserId();
	...
	private void addContactCacheUpdateListener() {
		if(mContactCacheUpdateListener!=null&& OpenImUtils.getImKit()!=null)
			OpenImUtils.getImKit().getContactService().addContactCacheUpdateListener(mContactCacheUpdateListener);
	}
	private void removeContactCacheUpdateListener() {
		if(mContactCacheUpdateListener!=null&& OpenImUtils.getImKit()!=null)
			OpenImUtils.getImKit().getContactService().removeContactCacheUpdateListener(mContactCacheUpdateListener);
	}
...
//			}
	...
	private void sendMessage(YWProfileInfo mYWProfileInfo) {
		if(mYWProfileInfo.userId.equals(OpenImUtils.getImKit().getIMCore().getLoginUserId())) {
