...
public class TribeInfoActivity extends Activity {
    ...
    private void initTitle() {
        ...
        titleView.setBackgroundColor(Color.parseColor("#03ccf5"));
                ...
                public void onClick(View v) {
                    mTribeService.disbandTribe(new IWxCallback() {
                        ...
                        public void onError(int code, String info) {
                            ...
                            Notification.showToastMsg(TribeInfoActivity.this, "解散群失败");
                        }
            ...
            mQuiteTribe.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mTribeService.exitFromTribe(new IWxCallback() {
                        ...
                        @Override
                        public void onError(int code, String info) {
                            YWLog.i(TAG, "退出群失败" + code + ", info = " + info);
                            Notification.showToastMsg(TribeInfoActivity.this, "退出群失败");
                        }
            ...
            mQuiteTribe.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mTribeService.joinTribe(new IWxCallback() {
                        ...
                        @Override
                        public void onError(int code, String info) {
                            YWLog.i(TAG, "加入群失败" + code + ", info = " + info);
