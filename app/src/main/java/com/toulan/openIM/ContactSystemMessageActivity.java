...
public class ContactSystemMessageActivity extends Activity {
    ...
    private void init(){
        initTitle();
        imKit = OpenImUtils.getImKit();
        mListView = (ListView) findViewById(R.id.message_list);
        mConversation = imKit.getConversationService().getCustomConversationByConversationId(ConversationListUI.SYSTEM_FRIEND_REQ_CONVERSATION);
        ...
        OpenImUtils.getImKit().getContactService().addProfileUpdateListener(iContactProfileUpdateListener);
    ...
    private IYWContactService getContactService(){
        return OpenImUtils.getImKit().getContactService();
    }
