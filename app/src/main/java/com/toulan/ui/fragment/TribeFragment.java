...
import com.toulan.openIM.EditTribeInfoActivity;
import com.toulan.openIM.SearchTribeActivity;
import com.toulan.openIM.TribeInfoActivity;
import com.toulan.ui.im.TribeAdapterSample;
import com.toulan.ui.im.TribeAndRoomList;
import com.toulan.ui.im.TribeConstants;
import com.toulan.ui.im.TribeSampleHelper;
 ...
 * 版本：verson 1.0
 */
public class TribeFragment extends Fragment implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener, AdapterView.OnItemLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_tribe, container, false);
...
//        mPullToRefreshListView.resetHeadLayout();
    ...
    private void showPopupMenu(View v) {
        final View bgView = View.inflate(TApplication.getApplication(), R.layout.demo_popup_window_bg, null);
        ...
        View view = View.inflate(TApplication.getApplication(), R.layout.demo_popup_menu, null);
        //创建群组
...
//                startActivityForResult(intent, 0);
        ...
        if (Tsp.isLogin() && !Tsp.getUserInfo().isMaster()){
            tribe.setVisibility(View.GONE);
    ...
    private void initTribeListView() {
        if (mMessageListView != null) {
            ...
            mMessageListView.setOnItemLongClickListener(this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position1,
        ...
        if (position >= 0 && position < mTribeAndRoomList.size()) {
            ...
            YWIMKit imKit = OpenImUtils.getImKit();
            //参数为群ID号
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position1, long id) {
        if (Tsp.isLogin() && Tsp.getUserInfo().isMaster()){
            ...
            if (position >= 0 && position < mTribeAndRoomList.size()) {
                ...
                YWTribe tribe = (YWTribe) mTribeAndRoomList.getItem(position);
                //参数为群ID号
                Intent intent = new Intent(mContext, TribeInfoActivity.class);
